...
import eightsCover from '../assets/eightsCover.PNG'
import juansTacos from '../sheetmusic/jt.pdf'
import jtCover from '../assets/jtCover.PNG'
import daily from '../sheetmusic/daily.pdf'
import dailyCover from '../assets/daily.PNG'
import duoSplit from '../sheetmusic/duoSplit.pdf'
import duoSplitCover from '../assets/duo.PNG'
import sixteenGrid from '../sheetmusic/16Grid.pdf'
import sixteenCover from '../assets/16Note.PNG'
import tripletGrid from '../sheetmusic/tripletGrid.pdf'
import tripletCover from '../assets/triplet.PNG'
import sixteenTiming from '../sheetmusic/16Timing.pdf'
import sixteenTimeCover from '../assets/16Timing.PNG'
import pantera from '../sheetmusic/pantera.pdf'
import panteraCover from '../assets/pantera.PNG'
